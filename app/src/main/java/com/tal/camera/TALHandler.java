...
public class TALHandler extends AHandler {

	private static final String TAG = "TALHandler";
	...
	private static TALHandler instance = null;
	...
	public static TALHandler getInstance() {
		if (instance == null) {
			instance = new TALHandler();
		}
		return instance;
	}
	...
	public boolean onConnected() {
		...
		TALAndroid.mainHandler.sendMessage(msg);
		return true;
	}
	...
	public boolean onTakePicture(String file_name) {
		...
		msg.setData(bdl);
		TALHandler.getInstance().sendMessage(msg);
		TALAndroid.lastPictureFileName = file_name;
		return true;
	}
